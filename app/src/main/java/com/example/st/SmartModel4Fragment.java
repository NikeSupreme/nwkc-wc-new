...
public class SmartModel4Fragment extends Fragment implements View.OnClickListener {

    private static String TAG = "SmartModel4Fragment";
    private String manFloorName = "男卫";
    ...
    private TextView tv_exist_1, tv_exist_2, tv_exist_3;
    ...
    public static SmartModel4Fragment newInstance() {
        SmartModel4Fragment fragment = new SmartModel4Fragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_smart_model4, container, false);
    }
    ...
    private void updateZoneView(int index, String status) {
        ...
        if (index == 0) {
            ...
            ViewUtil.updateZoneView(iv_man_3, status.equals("0") ? R.mipmap.icon_bottom_empty : R.mipmap.icon_bottom_exist, tv_exist_3, status.equals("1"));
        }
                ...
                if (b.getSubDevId().equals(devId)) {
                    ...
                    for (ZoneListBean.InfoBean.ContentBean contentBean :
                        ...
                        if (contentBean.getZoneId().equals(zoneId)) {
                            ...
                            Log.i(TAG, "alarmMsg: " + "男卫" + zoneName + "有人求助");
                            ViewUtil.showDialog(getActivity(),"男卫" + zoneName + "有人求助");
                        }
                    }
                }
            }
