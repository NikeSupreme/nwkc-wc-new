...
public class SmartModel5Fragment extends Fragment implements View.OnClickListener {
    private static String TAG = "SmartModel1Fragment";
    private String manFloorId, womanFloorId, otherFloorId;
    private String manFloorName, womanFloorName, otherFloorName;

    private double manH2sValue, womanH2sValue, otherH2sValue;
    private double manNh3Value, womanNh3Value, otherHNh3Value;
    ...
    private List<ZoneListBean.InfoBean.ContentBean> otherFloorZones = new ArrayList<>();
    ...
    private TextView tv_exist_1, tv_exist_2, tv_exist_3, tv_exist_4;//男卫人体存在
    private TextView tv_exist_5, tv_exist_6, tv_exist_7, tv_exist_8, tv_exist_10, tv_exist_11;//女卫人体存在
    private TextView tv_exist_9;//第三卫人体存在
    ...
    public static SmartModel5Fragment newInstance() {
        SmartModel5Fragment fragment = new SmartModel5Fragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_smart_model5, container, false);
    }
    ...
    private void initView(View view) {
        ...
        iv_other_1 = view.findViewById(R.id.iv_other_1);
        ...
        tv_other_1 = view.findViewById(R.id.tv_other_1);
        ...
        tv_exist_10 = view.findViewById(R.id.tv_exist_10);
        tv_exist_11 = view.findViewById(R.id.tv_exist_11);
    ...
    private void initData() {
        ...
        CmdUtil.reqFloorList(Constant.gwId, new CallbackImp() {
            ...
            public void success(Object data) {
                ...
                otherFloorId = Global.otherFloorId;
                manFloorName = Global.manFloorName;
                womanFloorName = Global.womanFloorName;
                otherFloorName = Global.otherFloorName;
                Log.i(getClass().getName(), "manFloor: " + manFloorName + ";womanFloor:" + womanFloorName + ",otherName:" + otherFloorName);
            }
        ...
        CmdUtil.reqZoneList(Constant.gwId, new CallbackImp() {
            ...
            public void success(Object data) {
                ...
                otherFloorZones = Global.otherFloorZones;
                setZoneName();
    ...
    private void setZoneName() {
        ...
        if (otherFloorZones.size() == 1) {
            ViewUtil.updateZoneName(tv_other_1, otherFloorZones.get(0).getName());
        }
    ...
    private void dealReportMsg(Object data) {
        ...
        if (deviceAttrsBean.getFunc().equals("devAttrsReportEvent")) {
            ...
            for (DeviceAttrsBean.AttrsInfoBean bean : attrsInfos
                ...
                if (bean.getSvcId().equals("23") && bean.getAttrId().equals("1")) {//紧急按钮
                ...
                } else if (bean.getSvcId().equals("1") && bean.getAttrId().equals("1")) {//内嵌
                    ...
                    for (ZoneListBean.InfoBean.ContentBean contentBean :
                            otherFloorZones) {
                        if (contentBean.getZoneId().equals(zoneId)) {
                            index = otherFloorZones.indexOf(contentBean);
                            updateZoneView("other", index, status);
                        }
                    }
                }
            }
    ...
    private void updateNH3Status(String devId, double nh3Value) {
        ...
        } else if (TextUtils.equals(otherFloorId, CmdUtil.getBelongFloorId(devId))) {
            otherHNh3Value = nh3Value;
        }
        Log.i(TAG, "manNh3Value:" + manNh3Value + ";womanNh3Value:" + womanNh3Value + ",otherHNh3Value:" + otherHNh3Value);
    ...
    private void updateH2sStatus(String devId, double h2sValue) {
        if (TextUtils.equals(manFloorId, CmdUtil.getBelongFloorId(devId))) {
            ...
            otherH2sValue = h2sValue;
        }
        Log.i(TAG, "manH2sValue:" + manH2sValue + ";womanH2sValue:" + womanH2sValue + ",otherH2sValue:" + otherH2sValue);
    ...
    private void updateSmellView() {
        ...
        if (otherH2sValue > 0.06 || otherHNh3Value > 1.5) {
            otherFloorText = otherFloorName + ": " + "<font color = '#FFD400'>有异味</font>";
        } else {
            otherFloorText = otherFloorName + ": 正常";
        }
        Log.i(TAG, otherFloorText);

        ViewUtil.updateGasText(tv_smell_show, ("异味监测" + " " + manFloorText + "\u3000\u3000" + womanFloorText + "\u3000\u3000" + otherFloorText));
    ...
    private void updateZoneView(String type, int index, String status) {
        ...
        ViewUtil.updateText(tv_man_position, "<font color = '#FFD400'>" + (4 - manExistNum) + "</font>" + "/4");
        ViewUtil.updateText(tv_woman_position, "<font color = '#FFD400'>" + (6 - womanExistNum) + "</font>" + "/6");
        switch (type) {
            case "man":
                if (index == 0) {
                    Log.i(TAG, "男卫生间坑位1---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_man_1, status.equals("0") ? R.mipmap.icon_5_top2 : R.mipmap.icon_5_top2_exist, tv_exist_1, status.equals("1"));
                } else if (index == 1) {
                    Log.i(TAG, "男卫生间坑位2---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_man_2, status.equals("0") ? R.mipmap.icon_5_top2 : R.mipmap.icon_5_top2_exist, tv_exist_2, status.equals("1"));
                } else if (index == 2) {
                    Log.i(TAG, "男卫生间坑位3---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_man_3, status.equals("0") ? R.mipmap.icon_5_top : R.mipmap.icon_5_top_exist, tv_exist_3, status.equals("1"));
                } else if (index == 3) {
                    Log.i(TAG, "男卫生间坑位4---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_man_4, status.equals("0") ? R.mipmap.icon_5_top : R.mipmap.icon_5_top_exist, tv_exist_4, status.equals("1"));
                }
                break;
            case "woman":
                if (index == 0) {
                    Log.i(TAG, "女卫生间坑位1---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_woman_1, status.equals("0") ? R.mipmap.icon_5_top2 : R.mipmap.icon_5_top2_exist, tv_exist_5, status.equals("1"));
                } else if (index == 1) {
                    Log.i(TAG, "女卫生间坑位2---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_woman_2, status.equals("0") ? R.mipmap.icon_5_top2 : R.mipmap.icon_5_top2_exist, tv_exist_6, status.equals("1"));
                } else if (index == 2) {
                    Log.i(TAG, "女卫生间坑位3---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_woman_3, status.equals("0") ? R.mipmap.icon_5_top2 : R.mipmap.icon_5_top2_exist, tv_exist_7, status.equals("1"));
                } else if (index == 3) {
                    Log.i(TAG, "女卫生间坑位4---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_woman_4, status.equals("0") ? R.mipmap.icon_5_bottom : R.mipmap.icon_5_bottom_exist, tv_exist_8, status.equals("1"));
                } else if (index == 4) {
                    Log.i(TAG, "女卫生间坑位5---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_woman_5, status.equals("0") ? R.mipmap.icon_5_bottom : R.mipmap.icon_5_bottom_exist, tv_exist_10, status.equals("1"));
                } else if (index == 5) {
                    Log.i(TAG, "女卫生间坑位6---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_woman_6, status.equals("0") ? R.mipmap.icon_5_bottom : R.mipmap.icon_5_bottom_exist, tv_exist_11, status.equals("1"));
                }
                break;
            case "other":
                if (index == 0) {
                    Log.i(TAG, "公关厕所坑位1---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_other_1, status.equals("0") ? R.mipmap.icon_5_third : R.mipmap.icon_5_third_exist, tv_exist_9, status.equals("1"));
                }
                break;
        }
