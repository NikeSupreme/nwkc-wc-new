...
import com.example.st.model.Model2Fragment;
...
import com.example.st.util.MediaUtil;
 ...
 * 模板1：男卫、女卫、第三卫
 */
public class SmartModel1Fragment extends Fragment implements View.OnClickListener {
    ...
    private ImageView iv_woman_1, iv_woman_2, iv_woman_3, iv_woman_4;
    private ImageView iv_other_1;

    private TextView tv_man_1, tv_man_2, tv_man_3, tv_man_4;
    private TextView tv_woman_1, tv_woman_2, tv_woman_3, tv_woman_4;
    ...
    public static SmartModel1Fragment newInstance() {
        SmartModel1Fragment fragment = new SmartModel1Fragment();
        return fragment;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_smart_model1, container, false);
    }
    ...
    private void updateZoneView(String type, int index, String status) {
        ...
        ViewUtil.updateText(tv_woman_position, "<font color = '#FFD400'>" + (4 - womanExistNum) + "</font>" + "/4");
        switch (type) {
            case "man":
                if (index == 0) {
                    ...
                    ViewUtil.updateZoneView(iv_man_4, status.equals("0") ? R.mipmap.icon_top_empty : R.mipmap.icon_top_exist, tv_exist_4, status.equals("1"));
                }
                break;
            case "woman":
                if (index == 0) {
                    Log.i(TAG, "女卫生间坑位1---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_woman_1, status.equals("0") ? R.mipmap.icon_left_empty : R.mipmap.icon_left_exist, tv_exist_5, status.equals("1"));
                } else if (index == 1) {
                    Log.i(TAG, "女卫生间坑位2---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_woman_2, status.equals("0") ? R.mipmap.icon_left_empty : R.mipmap.icon_left_exist, tv_exist_6, status.equals("1"));
                } else if (index == 2) {
                    Log.i(TAG, "女卫生间坑位3---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_woman_3, status.equals("0") ? R.mipmap.icon_right_empty : R.mipmap.icon_right_exist, tv_exist_7, status.equals("1"));
                } else if (index == 3) {
                    Log.i(TAG, "女卫生间坑位4---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_woman_4, status.equals("0") ? R.mipmap.icon_right_empty : R.mipmap.icon_right_exist, tv_exist_8, status.equals("1"));
                }
                break;
            case "other":
                if (index == 0) {
                    Log.i(TAG, "公关厕所坑位1---->" + (status.equals("0") ? "没人" : "有人"));
                    ViewUtil.updateZoneView(iv_other_1, status.equals("0") ? R.mipmap.icon_other_empty : R.mipmap.icon_other, tv_exist_9, status.equals("1"));
                }
                break;
        }
